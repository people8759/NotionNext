...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '石油王', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我是一個臭打游戲的宅男哥', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-79av.vercel.app', // 网站地址
